...
import app.galaxyvitals.data.protocol.csv.EcgMetaLineWriter
...
object EcgCsvWriter {
    ...
    fun encodeParsed(parsed: ParsedEcgFile): ByteArray {
        ...
        val body = buildString {
            append(EcgMetaLineWriter.metaLine(
                srHz = parsed.srHz,
                unit = parsed.unit,
    ...
    fun encodeCaptureV2(
        ...
        val body = buildString(valuesMv.size * 24) {
            append(EcgMetaLineWriter.metaLineV2(
                srHz = nominalSrHz,
    ...
    fun encodeCaptureV3(
        ...
        val body = buildString(valuesMv.size * 48 + bpmObservations.size * 160) {
            ...
            bpmObservations.forEachIndexed { id, observation ->
                EcgMetaLineWriter.appendBpmLine(this, id, observation)
            }
        }
        return body.toByteArray(Charsets.UTF_8)
    }
